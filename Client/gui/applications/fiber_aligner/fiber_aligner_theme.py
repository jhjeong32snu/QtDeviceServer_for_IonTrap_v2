...
class fiber_aligner_theme_base():
    ...
    def changeTheme(self, theme):
        self._theme = theme
        self.TabWidgetMain.setStyleSheet(self._theme_base[self._theme])
        ...
        self.GBOX_bottom.setStyleSheet(self._theme_base[self._theme])
