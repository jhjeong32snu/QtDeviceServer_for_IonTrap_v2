...
input_mapping = {'jb_2': 'PMT', 'jb_4': 'TRG'}

# Output port pin mapping
# For output pin, there might be more than one device controlled by the output pin
output_mapping = {'EOM_2G': 'jb_7', 'EOM_7G_1': 'jb_1', 'EOM_7G_2': 'jb_3', 'AOM': 'jb_5', 'MW': 'ja_3', 'AOM2': 'ja_1'}
description = {'EOM_2G': 'Initialization beam', 'EOM_7G_1': 'Cooling sideband', 'EOM_7G_2': 'Cooling sideband', 'AOM': 'Turning beam on/off', 'MW': 'Turing MW on/off', 'AOM2': 'Cooling beam for 170'}
